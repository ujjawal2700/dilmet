...
export const ReportModal = ({
  ...
  const reasons = [
    {
      ...
      label: t("reportReasonInappropriate") || "Inappropriate Behavior",
    },
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white dark:bg-[#2d1a24] w-full max-w-md rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden transform transition-all animate-in slide-in-from-bottom duration-300">
        <div className="p-6">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
            {t("reportingUser", { name: userName }) ||
              `You are reporting ${userName}. Please select a reason below.`}
          </p>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={
                  t("reportPlaceholder") || "Tell us more about the issue..."
                }
