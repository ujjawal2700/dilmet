        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Manage support conversations from male and female users ({total}{" "}
              total)
            </p>
          </div>
                    ...
                    tickets.map((t) => {
                      ...
                      return (
                        <tr
                          ...
                          onClick={() =>
                            navigate(`/admin/support-tickets/${t._id}`)
                          }>
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-2">
                              {hasUnread && (
                                <span className="size-2 rounded-full bg-pink-500 shrink-0" />
                              )}
                              <div>
                          ...
                          <td className="px-4 py-3">
                            ...
                            <div className="text-xs text-gray-500 dark:text-gray-400 max-w-xs truncate">
                              {t.lastMessageBySenderRole === "admin"
                                ? "You: "
                                : ""}
                          ...
                          <td className="px-4 py-3">
                            <span
                              className={`inline-block px-2 py-1 rounded text-xs font-medium ${statusMeta.className}`}>
                              {statusMeta.label}
                            </span>
                          </td>
